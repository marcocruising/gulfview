-- rpc_trade_group_world_share_by_hs6: rank Top N by combined group_export_usd_k (not group_share_pct first).
-- Apply after 20260411 or re-apply full schema/rpc_trade_dashboards.sql.
